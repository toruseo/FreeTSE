...
from FreeTSE import FreeTSE # Ensure FreeTSE can be imported
...
def test_ngsim_grid_scenario():
    ...
    tse.set_scenario(
        ...
        maxx=500,
        number_of_lanes=5,
        speed_data_name="./dat/ngsim_grid_speed_all.csv",
        speed_label_t="t",
        speed_label_x="x",
        speed_label_v="v",
    ...
    assert tse.speed_data_name == "./dat/ngsim_grid_speed_all.csv", "Speed data name should be set."
    assert tse.flow_data_name == "./dat/ngsim_grid_flow_200m.csv", "Flow data name should be set."
